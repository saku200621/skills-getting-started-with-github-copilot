...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice basketball skills, teamwork, and competitive play",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["noah@mergington.edu", "ava@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Build fitness and game strategy through soccer matches",
    ...
    "Music Ensemble": {
        "description": "Perform in group music sessions and school events",
